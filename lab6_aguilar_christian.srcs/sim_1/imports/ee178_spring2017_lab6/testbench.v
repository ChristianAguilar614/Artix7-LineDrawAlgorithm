...
module testbench;
  ...
  begin
    ...
    WRITE_REGISTER (REG_ADDR_STAY,176);
    WRITE_REGISTER (REG_ADDR_ENDX,128);
    WRITE_REGISTER (REG_ADDR_ENDY,250);
    SET_GO_POLL_BUSY;
    WRITE_REGISTER (REG_ADDR_STAX,128);
    WRITE_REGISTER (REG_ADDR_STAY,250);
    WRITE_REGISTER (REG_ADDR_ENDX,148);
    WRITE_REGISTER (REG_ADDR_ENDY,176);
    SET_GO_POLL_BUSY;
    WRITE_REGISTER (REG_ADDR_STAX,120);
    WRITE_REGISTER (REG_ADDR_STAY,200);
    WRITE_REGISTER (REG_ADDR_ENDX,136);
    WRITE_REGISTER (REG_ADDR_ENDY,200);
    SET_GO_POLL_BUSY;
